...
# class Publish:
#     def __init__(self, data: dict, colorspace: str):
#         self.data = data
...
#             version_entry["sg_clip_name"] = data["clip_name"]
#             version_entry["sg_pad"] = data["pad"]
#             version_entry["sg_ext"] = data["ext"]
#             version_entry["sg_resolution"] = data["resolution"]
#             version_entry["sg_start_frame"] = data["start_frame"]
#             version_entry["sg_end_frame"] = data["end_frame"]
#             version_entry["sg_duration"] = data["duration"]
#             version_entry["sg_retime_duration"] = data["retime_duration"]
#             version_entry["sg_retime_percent"] = data["retime_percent"]
#             version_entry["sg_retime_start_frame"] = data["retime_start_frame"]
#             version_entry["sg_timecode_in"] = data["timecode_in"]
#             version_entry["sg_timecode_out"] = data["timecode_out"]
#             version_entry["sg_just_in"] = data["just_in"]
#             version_entry["sg_just_out"] = data["just_out"]
#             version_entry["sg_framerate"] = data["framerate"]
#             version_entry["sg_date"] = data["date"]
#             version_entry["sg_clip_tag"] = data["clip_tag"]
...
#             output_path = (
#                 os.path.dirname(self.checked_data[row]["scan_path"])
#                 )
            
#             uploaded_movie_name = (
#                 f"{self.checked_data[row]['shot_name']}_"
#                 f"{colorspace}_"
#                 f"{self.checked_data[row]['type']}_v"
#                 f"{int(self.checked_data[row]['version']):03d}"
#                 ".mov"
#                 )
